Raphael.fn.drawGrid = function (x, y, w, h, wv, hv, color) {
    ...
    return this.path(path.join(",")).attr({stroke: color, 'stroke-width': 2});
};
...
window.onload = function () {
    ...
    r.drawGrid(leftgutter + X * .5 + .5, topgutter + .5, width - leftgutter - X, height - topgutter - bottomgutter, 11, 5, "#333");
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        if (!i) {
            ...
            // TODO: how to make the line straight? What about a regular line chart?
        }
        if (i && i < ii - 1) {
